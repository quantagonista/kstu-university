...
block_test = [['h', '2', '3', 'o'], ['5', '6', '7', '8'],
              ['9', '0', "11", '12'], ['13', '14', '15', '16']]
list_test = list('stringfortesting')
str_test = 'string for testing american encryption standart cipher'
key_test = 'cipherkeyfortest'
xor_test = [[1 for _ in range(4)] for _ in range(4)]
...
class AES():
    ...
    def key_expansion(self, key):
        key_schedule = self.split(self.make_blocks(key)[0], 4)
...
def main():
    # test()
    testr_hex_block = [['32','88','31', 'e0'],['43','5a','31', '37'],['f6','30','98', '07']]
    print(type(hex(16)) == str)    
